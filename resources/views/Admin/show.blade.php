    ...
    <ul id="nav">
        ...
        <li>
            <ul id="top-nav">
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Setup.png" alt="">
                        <p>首页</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Awards.png" alt="">
                        <p>商家信息</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Radio bug.png" alt="">
                        <p>新闻娱乐</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Chinese food.png" alt="">
                        <p>吃喝玩乐</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Bookkeeping.png" alt="">
                        <p>便民服务</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Dollar coin.png" alt="">
                        <p>优惠信息</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Joystick.png" alt="">
                        <p>在线游戏</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Theater symbol.png" alt="">
                        <p>热门活动</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Wall.png" alt="">
                        <p>酒店预订</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Message attention.png" alt="">
                        <p>联系我们</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Transport.png" alt="">
                        <p>本月院线</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Doghouse.png" alt="">
                        <p>房产</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Multimedia.png" alt="">
                        <p>车市</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Shoe.png" alt="">
                        <p>在线商城</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Ads.png" alt="">
                        <p>在线留言</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/List bullets.png" alt="">
                        <p>在线投票</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.html">
                        <img src="{{asset('huy')}}/images/Typewriter.png" alt="">
                        <p>问卷调查</p>
                    </a>
                </li>
            </ul>
