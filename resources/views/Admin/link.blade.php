...
<ul class="tabs" style="background-color: #faf3f3">
    <li class="current">
        <a href="javascript:void(0)" id="#tab1">友情链接</a>
    </li>
    <li>
        <a href="javascript:void(0)" id="#tab2">添加链接 </a>
    </li>
</ul>
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <label class="control-label" for="input01">
                                            链接名称</label>
                                        <div class="controls">
                                            <input type="password" class="input-xlarge" placeholder="请输入链接名称" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <label class="control-label" for="input01">
                                            链接地址</label>
                                        <div class="controls">
                                            <input type="password" class="input-xlarge" placeholder="请输入链接地址" />
